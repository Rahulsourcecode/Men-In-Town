...
  };
  ...
  //       const images= oldimage.concat(newimage)  
  //       console.log(images);      
  //        productData = await product.updateOne({ _id: req.query.id },{
  //         $set: {
  //           name: req.body.pName,
  ...
  //     res.render("editProducts", { admin: userData, category: categoryData, products: productData, message: "file should be image!!" })
  // };
  //   }
